...
if (isset($_GET['id'])) {
        $id = $_GET['id'];
$query = "SELECT * FROM transaksi_detail JOIN transaksi ON transaksi_detail.id_transaksi=transaksi.id_transaksi JOIN menu ON transaksi_detail.id_menu= menu.id_menu 
  ...
  <div align="center">
    ...
    <table style="width: 100%" class="">
      ...
      <tr>
            ...
            <tr>
                  ...
                  <td>
                    <?=date('d-F-Y H:i:s',strtotime($row['tanggal_waktu']))?>
                  </td>
                </tr>
      <tr>
      <tr>
    ...
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td align="right"><strong><?=number_format($row['bayar'])?></strong></td>
      </tr>
      <tr>
        <td align="right" colspan="4"><strong>Uang Kembali</strong></td>
        <td align="right"><strong><?=number_format($row['kembali'])?></strong></td>
      </tr>
      </table>
      <?php } ?>
      <hr>
